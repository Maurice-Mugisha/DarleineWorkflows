...
<table cellspacing = "1" cellpadding = "0" align = "center" width = "100%" id = "userstepmap">
 <tr>
 <td colspan = "7">&nbsp;&nbsp;&nbsp;&nbsp;</td>
 <td colspan = "2"><a href="target_print.php?userstepmap&&step_id=<?= $step_id ?>" target="_blank" style="color:#00FF00;">Print PDF</a></td></tr>
 <tr class = "top_row">
 <td>&nbsp;&nbsp;#&nbsp;&nbsp;</td>
 <td>&nbsp;User id&nbsp;</td>
 <td>&nbsp;First name&nbsp;</td>
