...
if(isset($_GET['specific_user'])):
	...
	while($row = mysqli_fetch_array($query)):
		...
		$secondary_query = $queryExecutor->execute($selectionObj->select_userstepmap_by_user($user_id));
...
<table cellspacing = "1" cellpadding = "0" align = "center" width = "100%" id = "userstepmap">
 <tr>
 <td colspan = "8">&nbsp;&nbsp;&nbsp;&nbsp;</td>
 <td colspan = "2"><a href="target_print.php?userstepmap&&user_id=<?= $user_id ?>" target="_blank" style="color:#00FF00;">Print PDF</a></td></tr>
 <tr class = "top_row">
 <td>&nbsp;&nbsp;#&nbsp;&nbsp;</td>
 <td>&nbsp;Step id&nbsp;</td>
 <td>&nbsp;Name&nbsp;</td>
