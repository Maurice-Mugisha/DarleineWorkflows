...
if(isset($_GET['specific_step'])):
	...
	while($row = mysqli_fetch_array($query)):
		...
		$secondary_query = $queryExecutor->execute($selectionObj->select_steprolemap_by_step($step_id));
...
<table cellspacing = "1" cellpadding = "0" align = "center" width = "100%" id = "steprolemap">
 <tr>
 <td colspan = "3">&nbsp;&nbsp;&nbsp;&nbsp;</td>
 <td colspan = "2"><a href="target_print.php?steprolemap&&step_id=<?= $step_id ?>" target="_blank" style="color:#00FF00;">Print PDF</a></td></tr>
 <tr class = "top_row">
 <td>&nbsp;&nbsp;#&nbsp;&nbsp;</td>
 <td>&nbsp;Role id&nbsp;</td>
 <td>&nbsp;Name&nbsp;</td>
